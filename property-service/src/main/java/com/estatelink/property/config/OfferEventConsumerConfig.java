...
/**
 * Consumer factories for the offer lifecycle events that drive listing status.
 * Producers disable JSON type headers, so each listener targets its DTO.
 */
@Configuration
public class OfferEventConsumerConfig {

    private static final String GROUP = "property-offer-group";
